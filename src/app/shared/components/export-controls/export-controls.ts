...
import { ExportFormat } from '../../interfaces/editor.interface';
import { LibButton } from '../lib-button/lib-button';
import { LibPill } from '../lib-pill/lib-pill';
...
export class ExportControls {
  ...
  public readonly buttonText = input<string>('Download Image');
  public readonly batchWarning = input<string | null>(null);
